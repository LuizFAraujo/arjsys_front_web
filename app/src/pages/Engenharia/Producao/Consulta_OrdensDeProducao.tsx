        ...
        <div className="flex flex-col p-4 h-full overflow-y-auto bg-gray-100">
            ...
            <div className="flex flex-col items-center flex-1">
                <div className="bg-white shadow-md rounded-lg p-6 w-full">
                    <h2 className="text-2xl font-bold mb-4">Consulta - Ordens de Produção</h2>
                    
                    <div className="mb-4 flex items-center space-x-4">
                        <label className="block text-gray-900 text-base font-bold mb-2">Código Ordem</label>
                                ...
                                <tbody>
                                    ...
                                    {Array.from({ length: 10 }).map((_, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="py-2 px-4 border-b">ORD-{index + 1}</td>
