...
const Consulta_Clientes: React.FC = () => {
    return (
        <div className="flex flex-col p-4 h-full overflow-y-auto bg-gray-100">
            ...
            <div className="flex flex-col items-center flex-1">
                <div className="bg-white shadow-md rounded-lg p-6 w-full">
                    <h2 className="text-2xl font-bold mb-4">Consulta - Clientes</h2>
                            ...
                            <table className="min-w-full bg-white">
                                <thead className="bg-gray-200 text-gray-600">
                                    <tr>
                                        ...
                                        <th className="py-2 px-4 border-b">Código Cliente</th>
                                ...
                                <tbody>
                                    ...
                                    {Array.from({ length: 10 }).map((_, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="py-2 px-4 border-b">CLI-{index + 1}</td>
                                            <td className="py-2 px-4 border-b">Nome Exemplo {index + 1}</td>
...
export default Consulta_Clientes;
